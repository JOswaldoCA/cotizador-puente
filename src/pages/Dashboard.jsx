...
const StatCard = ({ icon, label, value, color, onClick, gradient }) => (
  ...
  >
    <div
      className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl flex items-center justify-center text-xl flex-shrink-0 transition-transform duration-200 group-hover:scale-110"
