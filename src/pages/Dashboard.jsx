...
const StatCard = ({ icon, label, value, color, onClick, gradient }) => (
  <div
    onClick={onClick}
    className={`rounded-2xl p-5 flex items-center gap-4 border transition-all duration-200 ${onClick ? "cursor-pointer hover:scale-105" : ""}`}
    style={{
  ...
  >
    ...
    <div>
      ...
      <p className="text-3xl font-bold mt-0.5" style={{ color: "#1B3A6B" }}>
        {value}
      </p>
    </div>
  </div>
...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Selector de período */}
      <div
        className="flex items-center gap-1 bg-white border border-gray-100 rounded-2xl p-1.5 w-fit"
      ...
      >
        {[
          ...
          <button
            ...
            className="text-xs font-semibold px-5 py-2 rounded-xl transition-all duration-200"
            style={
              periodo === key
                ? {
      ...
      <div className="grid grid-cols-3 gap-4">
        <div
          className="rounded-2xl p-5 border border-amber-200 flex items-center gap-4"
          style={{
        ...
        >
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-emerald-700">{aprobadas}</p>
          </div>
        </div>
        <div
          className="rounded-2xl p-5 border border-red-200 flex items-center gap-4"
          style={{
